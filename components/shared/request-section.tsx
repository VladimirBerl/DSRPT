...
export default function RequestSection() {
  return (
    <section className="mb-[180px] max-xl:mb-[92px]">
      <h3 className="font-etude text-[96px] max-2xl:text-[64px] max-lg:text-[48px] max-md:text-[28px] leading-[92%] font-medium uppercase mb-[80px] max-md:mb-[32px]">
      ...
      <div className="flex max-md:flex-col-reverse items-center justify-between gap-10">
        <CastomLink className="max-w-[403px] max-md:max-w-full w-full mt-auto" href="/" icon={<TelegramIcon />}>
          Подать заявку
        </CastomLink>
